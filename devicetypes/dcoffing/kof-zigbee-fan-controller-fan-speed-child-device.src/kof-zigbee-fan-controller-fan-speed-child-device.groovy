...
metadata {
   ...
   tiles(scale: 2) {
        ...
        standardTile("fanSpeed", "fanSpeed", decoration: "flat", width: 2, height: 2) {  
     		state "off", label:"off", action: "on", icon: iconURL+"fan00h_grey.png", backgroundColor: "#ffffff", nextState: "turningOn"
            state "on01", label: "LOW", action: "off", icon: iconURL+"fan1j_on.png", backgroundColor: "#79b821", nextState: "turningOff"
           	state "on02", label: "MED", action: "off", icon: iconURL+"fan2j_on.png", backgroundColor: "#79b821", nextState: "turningOff"
			state "on03", label: "MED-HI", action: "off", icon: iconURL+"fan3j_on.png", backgroundColor: "#79b821", nextState: "turningOff"
			state "on04", label: "HIGH", action: "off", icon: iconURL+"fan4j_on.png", backgroundColor: "#79b821", nextState: "turningOff"
			state "on06", label: "BREEZE", action: "off", icon: iconURL+"breeze4h_teal.png", backgroundColor: "#79b821", nextState: "turningBreezeOff"
			state "off01", label: "LOW", action: "on", icon: iconURL+"fan1j_off.png", backgroundColor: "#ffffff", nextState: "turningOn"
           	state "off02", label: "MED", action: "on", icon: iconURL+"fan2j_off.png", backgroundColor: "#ffffff", nextState: "turningOn"
			state "off03", label: "MED-HI", action: "on", icon: iconURL+"fan3j_off.png", backgroundColor: "#ffffff", nextState: "turningOn"
			state "off04", label: "HIGH", action: "on", icon: iconURL+"fan4j_off.png", backgroundColor: "#ffffff", nextState: "turningOn"
			state "off06", label: "BREEZE", action: "on", icon: iconURL+"breeze4h_off.png", backgroundColor: "#ffffff", nextState: "turningBreezeOn"
        	state "turningOn", label:"ADJUSTING", action: "on", icon: iconURL+"Fan.png", backgroundColor: "#2179b8", nextState: "turningOn"
            state "turningOff", label:"TURNING OFF", action:"off", icon: iconURL+"Fan.png", backgroundColor:"#2179b8", nextState: "turningOff"
            state "turningBreezeOn", label:"ADJUSTING", action: "on", icon: iconURL+"breeze4h_blk.png", backgroundColor: "#2179b8", nextState: "turningOn"
            state "turningBreezeOff", label:"TURNING OFF", action:"off", icon: iconURL+"breeze4h_blk.png", backgroundColor:"#2179b8", nextState: "turningOff"
		}
